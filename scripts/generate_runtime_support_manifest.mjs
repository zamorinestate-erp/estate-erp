// =============================================================================
// ZAMORIN CAFÉ ERP — RUNTIME SUPPORT MANIFEST GENERATOR
// Generates artifacts/runtime_support_manifest.json with Two-Dimensional Status
// =============================================================================
...
const canonicalModules = [
  ...
  },
  {
    ...
    receiptSupport: "NOT_APPLICABLE",
    documentType: "NOT_APPLICABLE",
    testOwnership: "backend/test/employeeStaffDashboard.test.js",
    supportStatus: "COMPLETE",
    businessStatus: "READY",
    productionStatus: "PRODUCTION_VALIDATION_PENDING",
    userReviewStatus: "APPROVED",
    retiredStatus: "ACTIVE"
  },
  {
  ...
  },
  {
    ...
    family: "Workforce Operations",
    personas: ["MASTER", "CAFE_ADMIN", "STAFF"],
    route: "#attendance",
    frontendFile: "frontend/src/js/modules/attendance/attendanceShifts.js",
  ...
  },
  {
    ...
    testOwnership: "backend/test/businessModules.test.js",
    supportStatus: "COMPLETE",
    businessStatus: "BLOCKED_BUSINESS_DECISION (ACT-017 & ACT-018)",
    productionStatus: "PRODUCTION_VALIDATION_PENDING",
    userReviewStatus: "APPROVED",
    retiredStatus: "ACTIVE"
  },
  ...
  },
  {
    ...
    businessStatus: "READY",
    productionStatus: "PRODUCTION_VALIDATION_PENDING",
    userReviewStatus: "USER_REVIEW_PENDING",
    retiredStatus: "ACTIVE"
  },
  {
    id: "TRASH_DATA_RECOVERY",
  ...
  {
    id: "ANNOUNCEMENTS_NOTIFICATIONS",
...
const manifest = {
  ...
  totalModules: canonicalModules.length,
  supportCompleteCount: canonicalModules.filter(m => m.supportStatus.startsWith("COMPLETE")).length,
  businessBlockedCount: canonicalModules.filter(m => m.businessStatus.startsWith("BLOCKED")).length,
  userReviewPendingCount: canonicalModules.filter(m => m.userReviewStatus.startsWith("USER_REVIEW_PENDING")).length,
  productionPendingCount: canonicalModules.filter(m => m.productionStatus.includes("PENDING")).length,
  modules: canonicalModules
};

const targetPath = path.join(ROOT_DIR, 'artifacts/runtime_support_manifest.json');
fs.writeFileSync(targetPath, JSON.stringify(manifest, null, 2), 'utf8');
console.log(`✔ Generated ${targetPath} with ${canonicalModules.length} modules.`);
