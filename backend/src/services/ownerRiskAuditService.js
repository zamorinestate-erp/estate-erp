  ...
  static getAnomalyRuleCatalogue(organisationId = null) {
    return [
      ...
      },
      {
        ...
        description: 'Tracks off-hours permission grants, role alterations, and bypass of dual-approval gates',
        authoritativeSource: 'RoleAssignment & System Security Audit Log',
        threshold: 'Any elevation to MASTER/OWNER or privilege override outside business hours',
        lookbackPeriod: '24 Hours',
        scope: 'ORGANISATION',
        severity: 'CRITICAL',
        rationale: 'Protects system administrative access and privilege boundaries',
        version: '1.0.0',
        effectiveDate: '2026-01-01',
        enabled: true,
      },
